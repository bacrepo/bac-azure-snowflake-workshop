...
> In this workshop you'll build a semantic model and connect it to
> Snowflake Intelligence in **Lesson 07**.
...
| --- | --- | --- |
| **Data Engineering** | Stages & `COPY INTO` | Lesson 02 (Stages) |
| | Dynamic tables | Lesson 03 (Data engineering) |
| | Incremental loads, streams & tasks | Lesson 03 |
| **AI & ML** | Cortex AI (LLM functions) | Lesson 04 (Cortex Code) |
| | Cortex Code | Lesson 04 |
| | Cortex Analyst / semantic models | Lesson 07 (Snowflake Intelligence) |
| | Snowflake Intelligence | Lesson 07 |
| **Governance** | Horizon — policies, catalog, lineage | Lesson 08 (Governance) |
| **Development** | Snowpark | Lesson 05 (Notebooks & Snowpark) |
| | Notebooks | Lesson 05 |
